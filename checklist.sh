...
main() {
    ...
    echo "----------------------------------------"
    test_url "https://openhands.redacted" "cloudflare"
    test_url "https://llm-proxy.redacted" "cloudflare"
    test_url "https://flux-webhook.redacted" "cloudflare"
    test_url "http://auth.openhands.redacted" "cloudflare"
    echo

    # 2. DNS Resolution Tests
    echo -e "${BLUE}🔍 DNS RESOLUTION TESTS${NC}"
    echo "----------------------------------------"
    test_dns "openhands.redacted" "direct"
    test_dns "llm-proxy.redacted" "direct"
    test_dns "flux-webhook.redacted" "direct"
    test_dns "auth.openhands.redacted" "direct"
    echo
